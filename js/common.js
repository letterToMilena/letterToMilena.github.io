...
visiblePost = () => {
       if (document.getElementById('answer').getElementsByClassName('not_error').length<1){
        ...
        post.innerHTML+=`<br>Да, да. Это я, Алексей, твой недавний знакомый. Я задался, казалось бы, невыполнимой целью - отыскать тебя и заставить улыбнуться. И поэтому ты сейчас читаешь это письмо.
         Хотя очень трудно писать, Милена, ведь я тебя почти не знаю, но воспоминания о дне нашей встречи, не позволяют мне отступить…
         <br>Те самые воспоминания, когда мы шли по вечернему городу и весь этот город мне завидовал, ведь я шел с самой красивой девушкой Петербурга. 
         <br>И поэтому я верю, что в данном случае перспектива снова встретиться и узнать тебя больше 
         ...
         <br>
        У тебя появится вполне логичный вопрос, почему же таким странным способом, не через телефон, не через соц. сети и даже не на бумаге, а через сайт? На самом деле все просто, 
        я хоть и верю в то, что всё получится, но не хочу чтобы бумажное письмо попало кому-нибудь, кроме тебя. И если даже моя идея провалится, то о сайте ты узнала бы по-другому, а других способов я лишился.
         Ну да ладно, речь сейчас не об этом.
         <br>
         <br>Мне безгранично стыдно, ведь я обещал позвонить в вечер вторника, но Случай распорядился иначе.
         В первый вечер в Москве я лишился телефона, и чёрт бы с этим куском железа, но я лишился всех контактов с тобой.
         Сейчас я всё делаю, полагаясь исключительно на удачу, и я даже не знаю получишь ты цветы с конвертом или нет. 
         Я не из тех людей, кто привык сдаваться и поэтому хватаюсь за любую, даже самую безумную идею. И если ты сейчас читаешь это письмо, 
         то значит я все сделал правильно, безумная идея воплощена в жизнь и я безгранично этому рад.
          <br>
         ...
         касательно того, как я тебя искал. И я готов на всё тебе ответить за чашкой кофе или на прогулке. Верю в то, что цель достигнута и ты улыбаешься)
         ...
         <br>Мой новый номер: <a href="tel:+79967805722">89967805722</a>`;
