...
visiblePost = () => {
       if (document.getElementById('answer').getElementsByClassName('not_error').length<1){
        ...
        post.innerHTML+=`<br>Да, да. Это я, Алексей, твой недавний знакомый. Я задался, казалось бы, невыполнимой целью - отыскать тебя и заставить улыбнуться. И поэтому ты сейчас читаешь это письмо.
         ...
         <br>
        У тебя появится вполне логичный вопрос, почему же таким странным способом, не через телефон и даже не на бумаге, а через сайт? На самом деле все просто, 
        я хоть и верю в то, что всё получится, но не хочу чтобы бумажное письмо попало кому-нибудь, кроме тебя. И если даже моя идея провалится, то о сайте ты узнала бы по-другому. Ну да ладно, речь сейчас не об этом.
         <br>
